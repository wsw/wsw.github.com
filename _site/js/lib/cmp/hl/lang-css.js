...
define(function(require, exports, module) {
    ...
    (function() {
        ...
        var H = DlHighlight;
        var lang = H.registerLang("css", [ H.BASE.COMMENT_C, H.BASE.COMMENT_CPP, // not sure c++-style comments are allowed in CSS, but whatever
            H.BASE.STRING, T.AT_RULE, T.OUTBLOCK_STUFF, T.INBLOCK_STUFF, T.BEGIN_BLOCK, T.END_BLOCK
        ]);
