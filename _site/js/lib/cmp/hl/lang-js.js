...
define(function(require, exports, module) {
    var DlHighlight = require('./helpers');
    module.exports = DlHighlight;

    (function() {

        var builtins = [
            "Array", "Date", "Function", "Infinity", "Math", "NaN", "Number", "Object", "Packages", "RegExp", "String", "alert", "decodeURI", "decodeURIComponent", "document", "encodeURI", "encodeURIComponent", "eval", "isFinite", "isNaN", "parseFloat", "parseInt", "undefined", "window"
        ];
            ...
            WORD: function(txt) {
                ...
                if(m) {
                    ...
                    if(id in KEYWORDS) {
                        ...
                        if(id == "function") {
                            if(tok) {
                                if(tok.type == "operator" && tok.content == "=" || tok.type == "hasharrow")
