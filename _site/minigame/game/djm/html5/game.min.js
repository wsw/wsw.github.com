...
cc.kmMat4Multiply=function(a,b,c){var d=a.mat,e=b.mat[0],f=b.mat[1],g=b.mat[2],h=b.mat[3],k=b.mat[4],m=b.mat[5],n=b.mat[6],q=b.mat[7],t=b.mat[8],s=b.mat[9],r=b.mat[10],v=b.mat[11],u=b.mat[12],x=b.mat[13],w=b.mat[14];b=b.mat[15];var y=c.mat[0],K=c.mat[1],B=c.mat[2],F=c.mat[3],L=c.mat[4],ba=c.mat[5],D=c.mat[6],ca=c.mat[7],H=c.mat[8],T=c.mat[9],M=c.mat[10],Y=c.mat[11],Q=c.mat[12],Z=c.mat[13],da=c.mat[14];c=c.mat[15];d[0]=y*e+K*k+B*t+F*u;d[1]=y*f+K*m+B*s+F*x;d[2]=y*g+K*n+B*r+F*w;d[3]=y*h+K*q+B*v+F*b;
d[4]=L*e+ba*k+D*t+ca*u;d[5]=L*f+ba*m+D*s+ca*x;d[6]=L*g+ba*n+D*r+ca*w;d[7]=L*h+ba*q+D*v+ca*b;d[8]=H*e+T*k+M*t+Y*u;d[9]=H*f+T*m+M*s+Y*x;d[10]=H*g+T*n+M*r+Y*w;d[11]=H*h+T*q+M*v+Y*b;d[12]=Q*e+Z*k+da*t+c*u;d[13]=Q*f+Z*m+da*s+c*x;d[14]=Q*g+Z*n+da*r+c*w;d[15]=Q*h+Z*q+da*v+c*b;return a};
...
r;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(t=(2*t*f+1)/(2*e),q=t+(2*f-2)/(2*e),s=(2*s*g+1)/(2*d),r=s+(2*g-2)/(2*d)):(t=t*f/e,q=t+f/e,s=s*g/d,r=s+g/d);var v=h[n],u=v.tl,x=v.tr,w=v.bl,v=v.br;u.texCoords.u=t;u.texCoords.v=s;x.texCoords.u=q;x.texCoords.v=s;w.texCoords.u=t;w.texCoords.v=r;v.texCoords.u=q;v.texCoords.v=r;w.vertices.x=n*m;w.vertices.y=0;w.vertices.z=0;v.vertices.x=n*m+m;v.vertices.y=0;v.vertices.z=0;u.vertices.x=n*m;u.vertices.y=this._itemHeight;u.vertices.z=0;x.vertices.x=n*m+m;x.vertices.y=
this._itemHeight;x.vertices.z=0;u.colors=k;x.colors=k;w.colors=k;v.colors=k}0<b&&(c.dirty=!0,a=c.totalQuads,b>a&&c.increaseTotalQuadsWith(b-a))},setString:null,_setStringForCanvas:function(a){a=String(a);var b=a.length;this._string=a;this.width=b*this._itemWidth;this.height=this._itemHeight;if(this._children){a=this._children;for(var b=a.length,c=0;c<b;c++){var d=a[c];d&&!d._lateChild&&(d.visible=!1)}}this.updateAtlasValues();this.quadsToDraw=b},_setStringForWebGL:function(a){a=String(a);var b=a.length;
...
f[h.first<<16|h.second&65535]=h.amount;return c},load:function(a,b,c,d){var e=this;cc.loader.loadTxt(a,function(a,c){if(a)return d(a);d(null,e.parseFnt(c,b))})}};cc.loader.register(["fnt"],cc._fntLoader);cc.ACTION_TAG_INVALID=-1;
...
(f=Math.min,g=Math.max):(f=d,g=e);var h=function(a,b){return a<b?a+" "+b:b+" "+a},k=function(a,b){for(var c=0;c<a.length;c++)if(a[c]===b){a[c]=a[a.length-1];a.length--;break}};a.momentForCircle=function(a,b,c,d){return a*(0.5*(b*b+c*c)+H(d))};a.areaForCircle=function(a,b){return Math.PI*Math.abs(a*a-b*b)};a.momentForSegment=function(a,b,c){var d=x(y(c,b));b=B(w(b,c),0.5);return a*(d*d/12+H(b))};a.areaForSegment=function(a,b,c){return c*(Math.PI*c+2*Z(a,b))};a.momentForPoly=function(a,b,c){for(var d=
0,e=0,f=b.length,g=0;g<f;g+=2)var h=b[g]+c.x,k=b[g+1]+c.y,m=b[(g+2)%f]+c.x,n=b[(g+3)%f]+c.y,q=m*k-n*h,d=d+q*(h*h+k*k+(h*m+k*n)+(m*m+n*n)),e=e+q;return a*d/(6*e)};a.areaForPoly=function(a){for(var b=0,c=0,d=a.length;c<d;c+=2)b+=F(new r(a[c],a[c+1]),new r(a[(c+2)%d],a[(c+3)%d]));return-b/2};var m=a.centroidForPoly=function(a){for(var b=0,c=new r(0,0),d=0,e=a.length;d<e;d+=2)var f=new r(a[d],a[d+1]),g=new r(a[(d+2)%e],a[(d+3)%e]),h=F(f,g),b=b+h,c=w(c,B(w(f,g),h));return B(c,1/(3*b))};a.recenterPoly=
function(a){for(var b=m(a),c=0;c<a.length;c+=2)a[c]-=b.x,a[c+1]-=b.y};var n=a.momentForBox=function(a,b,c){return a*(b*b+c*c)/12};a.momentForBox2=function(a,b){width=b.r-b.l;height=b.t-b.b;offset=B([b.l+b.r,b.b+b.t],0.5);return n(a,width,height)+a*H(offset)};var q=function(a,b,c){return f(g(a,b),c)},t=a.clamp01=function(a){return g(0,f(a,1))},s=0,r=a.Vect=function(a,b){this.x=a;this.y=b;s++};a.v=function(a,b){return new r(a,b)};var v=a.vzero=new r(0,0),u=a.v.dot=function(a,b){return a.x*b.x+a.y*b.y},
x=a.v.len=function(a){return Math.sqrt(u(a,a))};a.v.eql=function(a,b){return a.x===b.x&&a.y===b.y};var w=a.v.add=function(a,b){return new r(a.x+b.x,a.y+b.y)};r.prototype.add=function(a){this.x+=a.x;this.y+=a.y;return this};var y=a.v.sub=function(a,b){return new r(a.x-b.x,a.y-b.y)};r.prototype.sub=function(a){this.x-=a.x;this.y-=a.y;return this};var K=a.v.neg=function(a){return new r(-a.x,-a.y)};r.prototype.neg=function(){this.x=-this.x;this.y=-this.y;return this};var B=a.v.mult=function(a,b){return new r(a.x*
b,a.y*b)};r.prototype.mult=function(a){this.x*=a;this.y*=a;return this};var F=a.v.cross=function(a,b){return a.x*b.y-a.y*b.x},L=a.v.perp=function(a){return new r(-a.y,a.x)};a.v.pvrperp=function(a){return new r(a.y,-a.x)};var ba=a.v.project=function(a,b){return B(b,u(a,b)/H(b))};r.prototype.project=function(a){this.mult(u(this,a)/H(a));return this};var D=a.v.rotate=function(a,b){return new r(a.x*b.x-a.y*b.y,a.x*b.y+a.y*b.x)};r.prototype.rotate=function(a){this.x=this.x*a.x-this.y*a.y;this.y=this.x*
a.y+this.y*a.x;return this};var ca=a.v.unrotate=function(a,b){return new r(a.x*b.x+a.y*b.y,a.y*b.x-a.x*b.y)},H=a.v.lengthsq=function(a){return u(a,a)},T=a.v.lerp=function(a,b,c){return w(B(a,1-c),B(b,c))},M=a.v.normalize=function(a){return B(a,1/x(a))},Y=a.v.normalize_safe=function(a){return 0===a.x&&0===a.y?v:M(a)},Q=a.v.clamp=function(a,b){return u(a,a)>b*b?B(M(a),b):a};a.v.lerpconst=function(a,b,c){return w(a,Q(y(b,a),c))};var Z=a.v.dist=function(a,b){return x(y(a,b))},da=a.v.distsq=function(a,
b){return H(y(a,b))};a.v.near=function(a,b,c){return da(a,b)<c*c};var cb=a.v.slerp=function(a,b,c){var d=Math.acos(u(a,b));if(d){var e=1/Math.sin(d);return w(B(a,Math.sin((1-c)*d)*e),B(b,Math.sin(c*d)*e))}return a};a.v.slerpconst=function(a,b,c){var d=Math.acos(u(a,b));return cb(a,b,f(c,d)/d)};a.v.forangle=function(a){return new r(Math.cos(a),Math.sin(a))};a.v.toangle=function(a){return Math.atan2(a.y,a.x)};a.v.str=function(a){return"("+a.x.toFixed(3)+", "+a.y.toFixed(3)+")"};var db=0,ea=a.BB=function(a,
b,c,d){this.l=a;this.b=b;this.r=c;this.t=d;db++};a.bb=function(a,b,c,d){return new ea(a,b,c,d)};var Ka=0;a.NO_GROUP=0;var eb=a.ALL_LAYERS=-1;a.resetShapeIdCounter=function(){Ka=0};var I=a.Shape=function(a){this.body=a;this.bb_l=this.bb_b=this.bb_r=this.bb_t=0;this.hashid=Ka++;this.sensor=!1;this.u=this.e=0;this.surface_v=v;this.group=this.collision_type=0;this.layers=eb;this.space=null;this.collisionCode=this.collisionCode};I.prototype.setElasticity=function(a){this.e=a};I.prototype.setFriction=function(a){this.body.activate();
...
this.body=a};I.prototype.cacheBB=function(){return this.update(this.body.p,this.body.rot)};I.prototype.update=function(a,c){b(!isNaN(c.x),"Rotation is NaN");b(!isNaN(a.x),"Position is NaN");this.cacheData(a,c)};I.prototype.getBB=function(){return new ea(this.bb_l,this.bb_b,this.bb_r,this.bb_t)};var ua=function(a){this.shape=a;this.d=Infinity;this.n=v},ia=function(a,b,c){this.shape=a;this.t=b;this.n=c};ia.prototype.hitPoint=function(a,b){return T(a,b,this.t)};ia.prototype.hitDist=function(a,b){return Z(a,
b)*this.t};var fa=a.CircleShape=function(a,b,c){this.c=this.tc=c;this.r=b;this.type="circle";I.call(this,a)};fa.prototype=Object.create(I.prototype);fa.prototype.cacheData=function(a,b){var c=this.tc=D(this.c,b).add(a),d=this.r;this.bb_l=c.x-d;this.bb_b=c.y-d;this.bb_r=c.x+d;this.bb_t=c.y+d};fa.prototype.pointQuery=function(a){a=y(a,this.tc);var b=H(a),c=this.r;if(b<c*c){var d=new ua(this),b=Math.sqrt(b);d.d=c-b;d.n=B(a,1/b);return d}};var va=function(a,b,c,d,e,f){d=y(d,b);e=y(e,b);b=u(d,d)-2*u(d,
e)+u(e,e);f=-2*u(d,d)+2*u(d,e);c=u(d,d)-c*c;c=f*f-4*b*c;if(0<=c&&(c=(-f-Math.sqrt(c))/(2*b),0<=c&&1>=c))return new ia(a,c,M(T(d,e,c)))};fa.prototype.segmentQuery=function(a,b){return va(this,this.tc,this.r,a,b)};var U=a.SegmentShape=function(a,b,c,d){this.a=b;this.b=c;this.n=L(M(y(c,b)));this.ta=this.tb=this.tn=null;this.r=d;this.b_tangent=this.a_tangent=v;this.type="segment";I.call(this,a)};U.prototype=Object.create(I.prototype);U.prototype.cacheData=function(a,b){this.ta=w(a,D(this.a,b));this.tb=
w(a,D(this.b,b));this.tn=D(this.n,b);var c,d,e,f;this.ta.x<this.tb.x?(c=this.ta.x,d=this.tb.x):(c=this.tb.x,d=this.ta.x);this.ta.y<this.tb.y?(e=this.ta.y,f=this.tb.y):(e=this.tb.y,f=this.ta.y);var g=this.r;this.bb_l=c-g;this.bb_b=e-g;this.bb_r=d+g;this.bb_t=f+g};U.prototype.pointQuery=function(a){if(this.bb_l<=a.x&&this.bb_r>=a.x&&this.bb_b<=a.y&&this.bb_t>=a.y){var b=this.ta,c=y(this.tb,b),d=t(u(c,y(a,b))/H(c)),b=w(b,B(c,d));a=y(a,b);d=H(a);b=this.r;if(d<b*b)return c=new ua(this),d=Math.sqrt(d),
c.d=b-d,c.n=B(a,1/d),c}};U.prototype.segmentQuery=function(a,b){var c=this.tn,d=u(y(this.ta,a),c),e=this.r,f=0<d?K(c):c,g=y(B(f,e),a),h=w(this.ta,g),k=w(this.tb,g),g=y(b,a);if(0>=F(g,h)*F(g,k)){if(e=d+(0<d?-e:e),d=-e,c=u(g,c)-e,0>d*c)return new ia(this,d/(d-c),f)}else if(0!==e)return f=va(this,this.ta,this.r,a,b),c=va(this,this.tb,this.r,a,b),f?c&&c.t<f.t?c:f:c};U.prototype.setNeighbors=function(a,b){this.a_tangent=y(a,this.a);this.b_tangent=y(b,this.b)};U.prototype.setEndpoints=function(a,b){this.a=
a;this.b=b;this.n=L(M(y(b,a)))};var J=a.PolyShape=function(a,c,d){b(4<=c.length,"Polygons require some verts");b("number"===typeof c[0],"Polygon verticies should be specified in a flattened list");var e;a:{e=c.length;for(var f=0;f<e;f+=2){var g=c[(f+2)%e],h=c[(f+3)%e];if(0<(g-c[f])*(c[(f+5)%e]-h)-(h-c[f+1])*(c[(f+4)%e]-g)){e=!1;break a}}e=!0}b(e,"Polygon is concave or has a reversed winding.");this.setVerts(c,d);this.type="poly";I.call(this,a)};J.prototype=Object.create(I.prototype);var La=function(a,
b){this.n=a;this.d=b};J.prototype.setVerts=function(a,b){var c=a.length,d=c>>1;this.verts=Array(c);this.tVerts=Array(c);this.axes=Array(d);this.tAxes=Array(d);for(d=0;d<c;d+=2){var e=a[d]+b.x,f=a[d+1]+b.y,g=M(L(new r(a[(d+2)%c]+b.x-e,a[(d+3)%c]+b.y-f)));this.verts[d]=e;this.verts[d+1]=f;this.axes[d>>1]=new La(g,g.x*e+g.y*f);this.tAxes[d>>1]=new La(new r(0,0),0)}};a.BoxShape=function(a,b,c){b/=2;c/=2;return fb(a,new ea(-b,-c,b,c))};var fb=a.BoxShape2=function(a,b){return new J(a,[b.l,b.b,b.l,b.t,b.r,
b.t,b.r,b.b],v)};J.prototype.transformVerts=function(a,b){for(var c=this.verts,d=this.tVerts,e=Infinity,h=-Infinity,k=Infinity,m=-Infinity,n=0;n<c.length;n+=2){var q=c[n],r=c[n+1],s=a.x+q*b.x-r*b.y,q=a.y+q*b.y+r*b.x;d[n]=s;d[n+1]=q;e=f(e,s);h=g(h,s);k=f(k,q);m=g(m,q)}this.bb_l=e;this.bb_b=k;this.bb_r=h;this.bb_t=m};J.prototype.transformAxes=function(a,b){for(var c=this.axes,d=this.tAxes,e=0;e<c.length;e++){var f=D(c[e].n,b);d[e].n=f;d[e].d=u(a,f)+c[e].d}};J.prototype.cacheData=function(a,b){this.transformAxes(a,
b);this.transformVerts(a,b)};J.prototype.pointQuery=function(a){if(this.bb_l<=a.x&&this.bb_r>=a.x&&this.bb_b<=a.y&&this.bb_t>=a.y){for(var b=new ua(this),c=this.tAxes,d=0;d<c.length;d++){var e=c[d].n,f=c[d].d-u(e,a);if(0>f)return;f<b.d&&(b.d=f,b.n=e)}return b}};J.prototype.segmentQuery=function(a,b){for(var c=this.tAxes,d=this.tVerts,e=c.length,f=2*e,g=0;g<e;g++){var h=c[g].n,k=u(a,h);if(!(c[g].d>k)){var m=u(b,h),k=(c[g].d-k)/(m-k);if(!(0>k||1<k)){var m=T(a,b,k),m=-F(h,m),n=-(h.x*d[(2*g+3)%f]-h.y*
d[(2*g+2)%f]);if(-(h.x*d[2*g+1]-h.y*d[2*g])<=m&&m<=n)return new ia(this,k,h)}}}};J.prototype.getNumVerts=function(){return this.verts.length/2};J.prototype.getVert=function(a){return new r(this.verts[2*a],this.verts[2*a+1])};J.prototype.valueOnAxis=function(a,b){for(var c=this.tVerts,d=a.x*c[0]+a.y*c[1],e=2;e<c.length;e+=2)d=f(d,a.x*c[e]+a.y*c[e+1]);return d-b};J.prototype.containsVert=function(a,b){for(var c=this.tAxes,d=0;d<c.length;d++){var e=c[d].n;if(0<e.x*a+e.y*b-c[d].d)return!1}return!0};J.prototype.containsVertPartial=
function(a,b,c){for(var d=this.tAxes,e=0;e<d.length;e++)if(c=d[e].n,!(0>u(c,c))&&0<c.x*a+c.y*b-d[e].d)return!1;return!0};J.prototype.getNumVerts=function(){return this.verts.length/2};J.prototype.getVert=function(a){return new r(this.verts[2*a],this.verts[2*a+1])};var A=a.Body=function(a,b){this.p=new r(0,0);this.vx=this.vy=0;this.f=new r(0,0);this.t=this.w=0;this.w_limit=this.v_limit=Infinity;this.w_bias=this.v_biasx=this.v_biasy=0;this.space=null;this.shapeList=[];this.nodeNext=this.nodeRoot=this.constraintList=
this.arbiterList=null;this.nodeIdleTime=0;this.setMass(a);this.setMoment(b);this.rot=new r(0,0);this.setAngle(0)};a.StaticBody=function(){body=new A(Infinity,Infinity);body.nodeIdleTime=Infinity;return body};if("undefined"!==typeof DEBUG&&DEBUG){var wa=function(a,c){b(a.x==a.x&&a.y==a.y,c)},xa=function(a,c){b(Infinity!==Math.abs(a.x)&&Infinity!==Math.abs(a.y),c)};A.prototype.sanityCheck=function(){b(this.m===this.m&&this.m_inv===this.m_inv,"Body's mass is invalid.");b(this.i===this.i&&this.i_inv===
this.i_inv,"Body's moment is invalid.");var a=this.p;wa(a,"Body's position is invalid.");xa(a,"Body's position is invalid.");a=this.f;wa(a,"Body's force is invalid.");xa(a,"Body's force is invalid.");b(this.vx===this.vx&&Infinity!==Math.abs(this.vx),"Body's velocity is invalid.");b(this.vy===this.vy&&Infinity!==Math.abs(this.vy),"Body's velocity is invalid.");b(this.a===this.a&&Infinity!==Math.abs(this.a),"Body's angle is invalid.");b(this.w===this.w&&Infinity!==Math.abs(this.w),"Body's angular velocity is invalid.");
b(this.t===this.t&&Infinity!==Math.abs(this.t),"Body's torque is invalid.");a=this.rot;wa(a,"Internal error: Body's rotation vector is invalid.");xa(a,"Internal error: Body's rotation vector is invalid.");b(this.v_limit===this.v_limit,"Body's velocity limit is invalid.");b(this.w_limit===this.w_limit,"Body's angular velocity limit is invalid.")}}else A.prototype.sanityCheck=function(){};A.prototype.getPos=function(){return this.p};A.prototype.getVel=function(){return new r(this.vx,this.vy)};A.prototype.getAngVel=
function(){return this.w};A.prototype.isSleeping=function(){return null!==this.nodeRoot};A.prototype.isStatic=function(){return Infinity===this.nodeIdleTime};A.prototype.isRogue=function(){return null===this.space};A.prototype.setMass=function(a){b(0<a,"Mass must be positive and non-zero.");this.activate();this.m=a;this.m_inv=1/a};A.prototype.setMoment=function(a){b(0<a,"Moment of Inertia must be positive and non-zero.");this.activate();this.i=a;this.i_inv=1/a};A.prototype.addShape=function(a){this.shapeList.push(a)};
A.prototype.removeShape=function(a){k(this.shapeList,a)};var ya=function(a,b,c){if(a===c)return a.next(b);a.a===b?a.next_a=ya(a.next_a,b,c):a.next_b=ya(a.next_b,b,c);return a};A.prototype.removeConstraint=function(a){this.constraintList=ya(this.constraintList,this,a)};A.prototype.setPos=function(a){this.activate();this.sanityCheck();this.p=a};A.prototype.setVel=function(a){this.activate();this.vx=a.x;this.vy=a.y};A.prototype.setAngVel=function(a){this.activate();this.w=a};A.prototype.setAngleInternal=
function(a){b(!isNaN(a),"Internal Error: Attempting to set body's angle to NaN");this.a=a;this.rot.x=Math.cos(a);this.rot.y=Math.sin(a)};A.prototype.setAngle=function(a){this.activate();this.sanityCheck();this.setAngleInternal(a)};A.prototype.velocity_func=function(a,b,c){var d=this.vx*b+(a.x+this.f.x*this.m_inv)*c;a=this.vy*b+(a.y+this.f.y*this.m_inv)*c;var e=this.v_limit,f=d*d+a*a,e=f>e*e?e/Math.sqrt(f):1;this.vx=d*e;this.vy=a*e;d=this.w_limit;this.w=q(this.w*b+this.t*this.i_inv*c,-d,d);this.sanityCheck()};
A.prototype.position_func=function(a){this.p.x+=(this.vx+this.v_biasx)*a;this.p.y+=(this.vy+this.v_biasy)*a;this.setAngleInternal(this.a+(this.w+this.w_bias)*a);this.w_bias=this.v_biasx=this.v_biasy=0;this.sanityCheck()};A.prototype.resetForces=function(){this.activate();this.f=new r(0,0);this.t=0};A.prototype.applyForce=function(a,b){this.activate();this.f=w(this.f,a);this.t+=F(b,a)};A.prototype.applyImpulse=function(a,b){this.activate();za(this,a.x,a.y,b)};A.prototype.getVelAtPoint=function(a){return w(new r(this.vx,
this.vy),B(L(a),this.w))};A.prototype.getVelAtWorldPoint=function(a){return this.getVelAtPoint(y(a,this.p))};A.prototype.getVelAtLocalPoint=function(a){return this.getVelAtPoint(D(a,this.rot))};A.prototype.eachShape=function(a){for(var b=0,c=this.shapeList.length;b<c;b++)a(this.shapeList[b])};A.prototype.eachConstraint=function(a){for(var b=this.constraintList;b;){var c=b.next(this);a(b);b=c}};A.prototype.eachArbiter=function(a){for(var b=this.arbiterList;b;){var c=b.next(this);b.swappedColl=this===
b.body_b;a(b);b=c}};A.prototype.local2World=function(a){return w(this.p,D(a,this.rot))};A.prototype.world2Local=function(a){return ca(y(a,this.p),this.rot)};A.prototype.kineticEnergy=function(){var a=this.vx*this.vx+this.vy*this.vy,b=this.w*this.w;return(a?a*this.m:0)+(b?b*this.i:0)};var Aa=a.SpatialIndex=function(a){if(this.staticIndex=a)b(!a.dynamicIndex,"This static index is already associated with a dynamic index."),a.dynamicIndex=this};Aa.prototype.collideStatic=function(a,b){if(0<a.count){var c=
a.query;this.each(function(a){c(a,new ea(a.bb_l,a.bb_b,a.bb_r,a.bb_t),b)})}};var G=a.BBTree=function(a){Aa.call(this,a);this.velocityFunc=null;this.leaves={};this.count=0;this.root=null;this.stamp=0};G.prototype=Object.create(Aa.prototype);var gb=0,R=function(a,b,c){this.obj=null;this.bb_l=f(b.bb_l,c.bb_l);this.bb_b=f(b.bb_b,c.bb_b);this.bb_r=g(b.bb_r,c.bb_r);this.bb_t=g(b.bb_t,c.bb_t);this.parent=null;this.setA(b);this.setB(c);gb++},hb=0,V=function(a,b){this.obj=b;a.getBB(b,this);this.parent=null;
this.stamp=1;this.pairs=null;hb++};G.prototype.getBB=function(a,b){var c=this.velocityFunc;if(c){var d=0.1*(a.bb_r-a.bb_l),e=0.1*(a.bb_t-a.bb_b),c=B(c(a),0.1);b.bb_l=a.bb_l+f(-d,c.x);b.bb_b=a.bb_b+f(-e,c.y);b.bb_r=a.bb_r+g(d,c.x);b.bb_t=a.bb_t+g(e,c.y)}else b.bb_l=a.bb_l,b.bb_b=a.bb_b,b.bb_r=a.bb_r,b.bb_t=a.bb_t};G.prototype.getStamp=function(){var a=this.dynamicIndex;return a&&a.stamp?a.stamp:this.stamp};G.prototype.incrementStamp=function(){this.dynamicIndex&&this.dynamicIndex.stamp?this.dynamicIndex.stamp++:
this.stamp++};var ib=function(a,b){this.a=a;this.b=b},Ba=function(a,b){this.prev=null;this.next=b;this.leaf=a};Ba.prototype.unlink=function(){var a=this.next,b=this.prev;a&&(a.a.leaf==this.leaf?a.a.prev=b:a.b.prev=b);b?b.a.leaf==this.leaf?b.a.next=a:b.b.next=a:this.leaf.pairs=a};V.prototype.clearPairs=function(a){a=this.pairs;var b;for(this.pairs=null;a;)a.a.leaf==this?(b=a.a.next,a.b.unlink()):(b=a.b.next,a.a.unlink()),a=b};var Ma=function(a,b,c){c=a.pairs;var d=b.pairs,e=new ib(new Ba(a,c),new Ba(b,
d));a.pairs=b.pairs=e;c&&(c.a.leaf==a?c.a.prev=e:c.b.prev=e);d&&(d.a.leaf==b?d.a.prev=e:d.b.prev=e)};R.prototype.setA=function(a){this.A=a;a.parent=this};R.prototype.setB=function(a){this.B=a;a.parent=this};V.prototype.isLeaf=!0;R.prototype.isLeaf=!1;R.prototype.otherChild=function(a){return this.A==a?this.B:this.A};R.prototype.replaceChild=function(a,b,d){c(a==this.A||a==this.B,"Node is not a child of parent.");this.A==a?this.setA(b):this.setB(b);for(a=this;a;a=a.parent)b=a.A,d=a.B,a.bb_l=f(b.bb_l,
d.bb_l),a.bb_b=f(b.bb_b,d.bb_b),a.bb_r=g(b.bb_r,d.bb_r),a.bb_t=g(b.bb_t,d.bb_t)};R.prototype.bbArea=V.prototype.bbArea=function(){return(this.bb_r-this.bb_l)*(this.bb_t-this.bb_b)};var Na=function(a,b){return(g(a.bb_r,b.bb_r)-f(a.bb_l,b.bb_l))*(g(a.bb_t,b.bb_t)-f(a.bb_b,b.bb_b))},Oa=function(a,b){return Math.abs(a.bb_l+a.bb_r-b.bb_l-b.bb_r)+Math.abs(a.bb_b+b.bb_t-b.bb_b-b.bb_t)},ja=function(a,b,c){if(null==a)return b;if(a.isLeaf)return new R(c,b,a);var d=a.B.bbArea()+Na(a.A,b),e=a.A.bbArea()+Na(a.B,
b);d===e&&(d=Oa(a.A,b),e=Oa(a.B,b));e<d?a.setB(ja(a.B,b,c)):a.setA(ja(a.A,b,c));a.bb_l=f(a.bb_l,b.bb_l);a.bb_b=f(a.bb_b,b.bb_b);a.bb_r=g(a.bb_r,b.bb_r);a.bb_t=g(a.bb_t,b.bb_t);return a};R.prototype.intersectsBB=V.prototype.intersectsBB=function(a){return this.bb_l<=a.r&&a.l<=this.bb_r&&this.bb_b<=a.t&&a.b<=this.bb_t};var ta=function(a,b,c){a.intersectsBB(b)&&(a.isLeaf?c(a.obj):(ta(a.A,b,c),ta(a.B,b,c)))},Pa=function(a,b,c){var d=1/(c.x-b.x),e=a.bb_l==b.x?-Infinity:(a.bb_l-b.x)*d,h=a.bb_r==b.x?Infinity:
(a.bb_r-b.x)*d,d=f(e,h),e=g(e,h),h=1/(c.y-b.y);c=a.bb_b==b.y?-Infinity:(a.bb_b-b.y)*h;b=a.bb_t==b.y?Infinity:(a.bb_t-b.y)*h;a=f(c,b);b=g(c,b);return a<=e&&d<=b&&(d=g(d,a),0<=f(e,b)&&1>=d)?g(d,0):Infinity},ka=function(a,b,c,d,e){if(a.isLeaf)return e(a.obj);var g=Pa(a.A,b,c),h=Pa(a.B,b,c);g<h?(g<d&&(d=f(d,ka(a.A,b,c,d,e))),h<d&&(d=f(d,ka(a.B,b,c,d,e)))):(h<d&&(d=f(d,ka(a.B,b,c,d,e))),g<d&&(d=f(d,ka(a.A,b,c,d,e))));return d},Qa=function(a,b,c){if(b==a)return null;var d=b.parent;if(d==a)return b=a.otherChild(b),
b.parent=a.parent,b;d.parent.replaceChild(d,d.otherChild(b),c);return a},ga=function(a,b,c,d,e){b.bb_l<=a.bb_r&&a.bb_l<=b.bb_r&&b.bb_b<=a.bb_t&&a.bb_b<=b.bb_t&&(a.isLeaf?c?Ma(b,a,d):(a.stamp<b.stamp&&Ma(a,b,d),e&&e(b.obj,a.obj)):(ga(a.A,b,c,d,e),ga(a.B,b,c,d,e)))},Ra=function(a,b,c,d){if(a.stamp==b.getStamp())for(c&&ga(c,a,!1,b,d),c=a;c.parent;c=c.parent)c==c.parent.A?ga(c.parent.B,a,!0,b,d):ga(c.parent.A,a,!1,b,d);else for(b=a.pairs;b;)a==b.b.leaf?(d&&d(b.a.leaf.obj,a.obj),b=b.b.next):b=b.a.next},
Ca=function(a,b,c,d){a.isLeaf?Ra(a,b,c,d):(Ca(a.A,b,c,d),Ca(a.B,b,c,d))};V.prototype.containsObj=function(a){return this.bb_l<=a.bb_l&&this.bb_r>=a.bb_r&&this.bb_b<=a.bb_b&&this.bb_t>=a.bb_t};V.prototype.update=function(a){var b=a.root;return this.containsObj(this.obj)?!1:(a.getBB(this.obj,this),b=Qa(b,this,a),a.root=ja(b,this,a),this.clearPairs(a),this.stamp=a.getStamp(),!0)};V.prototype.addPairs=function(a){var b=a.dynamicIndex;b?(a=b.root)&&ga(a,this,!0,b,null):Ra(this,a,a.staticIndex.root,null)};
G.prototype.insert=function(a,b){var c=new V(this,a);this.leaves[b]=c;this.root=ja(this.root,c,this);this.count++;c.stamp=this.getStamp();c.addPairs(this);this.incrementStamp()};G.prototype.remove=function(a,b){var c=this.leaves[b];delete this.leaves[b];this.root=Qa(this.root,c,this);this.count--;c.clearPairs(this)};G.prototype.contains=function(a,b){return null!=this.leaves[b]};var jb=function(a,b){};G.prototype.reindexQuery=function(a){if(this.root){var b,c=this.leaves;for(b in c)c[b].update(this);
c=(b=this.staticIndex)&&b.root;Ca(this.root,this,c,a);b&&!c&&this.collideStatic(this,b,a);this.incrementStamp()}};G.prototype.reindex=function(){this.reindexQuery(jb)};G.prototype.reindexObject=function(a,b){var c=this.leaves[b];c&&(c.update(this)&&c.addPairs(this),this.incrementStamp())};G.prototype.pointQuery=function(a,b){this.root&&ta(this.root,new ea(a.x,a.y,a.x,a.y),b)};G.prototype.segmentQuery=function(a,b,c,d){this.root&&ka(this.root,a,b,c,d)};G.prototype.query=function(a,b){this.root&&ta(this.root,
a,b)};G.prototype.count=function(){return this.count};G.prototype.each=function(a){for(var b in this.leaves)a(this.leaves[b].obj)};var Sa=function(a,b,c,d,e){return(g(a.bb_r,d)-f(a.bb_l,b))*(g(a.bb_t,e)-f(a.bb_b,c))},Da=function(a,b,c,d){if(1==d)return b[c];if(2==d)return new R(a,b[c],b[c+1]);for(var e=b[c],h=e.bb_l,k=e.bb_b,m=e.bb_r,n=e.bb_t,q=c+d,r=c+1;r<q;r++)e=b[r],h=f(h,e.bb_l),k=f(k,e.bb_b),m=g(m,e.bb_r),n=g(n,e.bb_t);var e=m-h>n-k,s=Array(2*d);if(e)for(r=c;r<q;r++)s[2*r+0]=b[r].bb_l,s[2*r+
1]=b[r].bb_r;else for(r=c;r<q;r++)s[2*r+0]=b[r].bb_b,s[2*r+1]=b[r].bb_t;s.sort(function(a,b){return a-b});var t=0.5*(s[d-1]+s[d]),r=h,s=k,u=m,v=n;e?u=h=t:v=k=t;for(var t=q,w=c;w<t;)e=b[w],Sa(e,h,k,m,n)<Sa(e,r,s,u,v)?(t--,b[w]=b[t],b[t]=e):w++;if(t==d){e=null;for(r=c;r<q;r++)e=ja(e,b[r],a);return e}return NodeNew(a,Da(a,b,c,t-c),Da(a,b,t,q-t))};G.prototype.optimize=function(){var a=Array(this.count),b=0,c;for(c in this.leaves)a[b++]=this.nodes[c];this.root=Da(tree,a,a.length)};var Ea=function(a,b){!a.isLeaf&&
10>=b&&(Ea(a.a,b+1),Ea(a.b,b+1));for(var c=0;c<b;c++);};G.prototype.log=function(){this.root&&Ea(this.root,0)};var aa=a.CollisionHandler=function(){this.a=this.b=0};aa.prototype.begin=function(a,b){return!0};aa.prototype.preSolve=function(a,b){return!0};aa.prototype.postSolve=function(a,b){};aa.prototype.separate=function(a,b){};var E=function(a,b){this.u=this.e=0;this.surface_vr=v;this.a=a;this.body_a=a.body;this.b=b;this.body_b=b.body;this.contacts=this.thread_b_next=this.thread_b_prev=this.thread_a_next=
this.thread_a_prev=null;this.stamp=0;this.handler=null;this.swappedColl=!1;this.state="first coll"};E.prototype.getShapes=function(){return this.swappedColl?[this.b,this.a]:[this.a,this.b]};E.prototype.totalImpulse=function(){for(var a=this.contacts,b=new r(0,0),c=0,d=a.length;c<d;c++){var e=a[c];b.add(B(e.n,e.jnAcc))}return this.swappedColl?b:b.neg()};E.prototype.totalImpulseWithFriction=function(){for(var a=this.contacts,b=new r(0,0),c=0,d=a.length;c<d;c++){var e=a[c];b.add((new r(e.jnAcc,e.jtAcc)).rotate(e.n))}return this.swappedColl?
b:b.neg()};E.prototype.totalKE=function(){for(var a=(1-this.e)/(1+this.e),b=0,c=this.contacts,d=0,e=c.length;d<e;d++)var f=c[d],g=f.jnAcc,h=f.jtAcc,b=b+(a*g*g/f.nMass+h*h/f.tMass);return b};E.prototype.ignore=function(){this.state="ignore"};E.prototype.getA=function(){return this.swappedColl?this.b:this.a};E.prototype.getB=function(){return this.swappedColl?this.a:this.b};E.prototype.isFirstContact=function(){return"first coll"===this.state};var Ta=function(a,b,c){this.point=a;this.normal=b;this.dist=
c};E.prototype.getContactPointSet=function(){var a=Array(this.contacts.length),b;for(b=0;b<a.length;b++)a[b]=new Ta(this.contacts[b].p,this.contacts[b].n,this.contacts[b].dist);return a};E.prototype.getNormal=function(a){a=this.contacts[a].n;return this.swappedColl?K(a):a};E.prototype.getPoint=function(a){return this.contacts[a].p};E.prototype.getDepth=function(a){return this.contacts[a].dist};var Ua=function(a,b,c,d){c?c.body_a===b?c.thread_a_next=d:c.thread_b_next=d:b.arbiterList=d;d&&(d.body_a===
b?d.thread_a_prev=c:d.thread_b_prev=c)};E.prototype.unthread=function(){Ua(this,this.body_a,this.thread_a_prev,this.thread_a_next);Ua(this,this.body_b,this.thread_b_prev,this.thread_b_next);this.thread_b_prev=this.thread_b_next=this.thread_a_prev=this.thread_a_next=null};E.prototype.update=function(a,b,c,d){if(this.contacts)for(var e=0;e<this.contacts.length;e++)for(var f=this.contacts[e],g=0;g<a.length;g++){var h=a[g];h.hash===f.hash&&(h.jnAcc=f.jnAcc,h.jtAcc=f.jtAcc)}this.contacts=a;this.handler=
b;this.swappedColl=c.collision_type!==b.a;this.e=c.e*d.e;this.u=c.u*d.u;this.surface_vr=y(c.surface_v,d.surface_v);this.a=c;this.body_a=c.body;this.b=d;this.body_b=d.body;"cached"==this.state&&(this.state="first coll")};E.prototype.preStep=function(a,b,c){for(var d=this.body_a,e=this.body_b,g=0;g<this.contacts.length;g++){var h=this.contacts[g];h.r1=y(h.p,d.p);h.r2=y(h.p,e.p);h.nMass=1/la(d,e,h.r1,h.r2,h.n);h.tMass=1/la(d,e,h.r1,h.r2,L(h.n));h.bias=-c*f(0,h.dist+b)/a;h.jBias=0;h.bounce=Fa(d,e,h.r1,
h.r2,h.n)*this.e}};E.prototype.applyCachedImpulse=function(a){if(!this.isFirstContact())for(var b=this.body_a,c=this.body_b,d=0;d<this.contacts.length;d++){var e=this.contacts[d],f=e.n.x,g=e.n.y;N(b,c,e.r1,e.r2,(f*e.jnAcc-g*e.jtAcc)*a,(f*e.jtAcc+g*e.jnAcc)*a)}};var kb=0,lb=0;E.prototype.applyImpulse=function(){kb++;for(var a=this.body_a,b=this.body_b,c=this.surface_vr,d=this.u,e=0;e<this.contacts.length;e++){lb++;var f=this.contacts[e],h=f.nMass,k=f.n,m=f.r1,n=f.r2,r=b.vx-n.y*b.w-(a.vx-m.y*a.w),s=
b.vy+n.x*b.w-(a.vy+m.x*a.w),t=r*k.x+s*k.y,u=(r+c.x)*-k.y+(s+c.y)*k.x,s=f.jBias;f.jBias=g(s+(f.bias-(k.x*(b.v_biasx-n.y*b.w_bias-a.v_biasx+m.y*a.w_bias)+k.y*(n.x*b.w_bias+b.v_biasy-m.x*a.w_bias-a.v_biasy)))*h,0);r=f.jnAcc;f.jnAcc=g(r+-(f.bounce+t)*h,0);t=d*f.jnAcc;h=f.jtAcc;f.jtAcc=q(h+-u*f.tMass,-t,t);t=k.x*(f.jBias-s);s=k.y*(f.jBias-s);Va(a,-t,-s,m);Va(b,t,s,n);r=f.jnAcc-r;f=f.jtAcc-h;N(a,b,m,n,k.x*r-k.y*f,k.x*f+k.y*r)}};E.prototype.callSeparate=function(a){a.lookupHandler(this.a.collision_type,
this.b.collision_type).separate(this,a)};E.prototype.next=function(a){return this.body_a==a?this.thread_a_next:this.thread_b_next};var mb=0,S=function(a,b,c,d){this.p=a;this.n=b;this.dist=c;this.r1=this.r2=v;this.jnAcc=this.jtAcc=this.jBias=this.nMass=this.tMass=this.bounce=this.bias=0;this.hash=d;mb++},O=[],W=function(a,b,c,d){d=c+d;b=y(b,a);var e=H(b);if(!(e>=d*d))return e=Math.sqrt(e),new S(w(a,B(b,0.5+(c-0.5*d)/(e?e:Infinity))),e?B(b,1/e):new r(1,0),e-d,0)},Ga=0,Wa=function(a,b){var c=0,d=a.valueOnAxis(b[0].n,
b[0].d);if(0<d)return-1;for(var e=1;e<b.length;e++){var f=a.valueOnAxis(b[e].n,b[e].d);if(0<f)return-1;f>d&&(d=f,c=e)}Ga=d;return c},Xa=function(a,b,c,d){for(var e=[],f=a.tVerts,g=0;g<f.length;g+=2){var k=f[g],m=f[g+1];b.containsVert(k,m)&&e.push(new S(new r(k,m),c,d,h(a.hashid,g>>1)))}f=b.tVerts;for(g=0;g<f.length;g+=2)k=f[g],m=f[g+1],a.containsVert(k,m)&&e.push(new S(new r(k,m),c,d,h(b.hashid,g>>1)));if(!e.length){e=[];f=a.tVerts;for(g=0;g<f.length;g+=2)k=f[g],m=f[g+1],b.containsVertPartial(k,m,
K(c))&&e.push(new S(new r(k,m),c,d,h(a.hashid,g)));f=b.tVerts;for(g=0;g<f.length;g+=2)k=f[g],m=f[g+1],a.containsVertPartial(k,m,c)&&e.push(new S(new r(k,m),c,d,h(b.hashid,g)))}return a=e},Ya=function(a,b,c){var d=u(b,a.ta)-a.r;a=u(b,a.tb)-a.r;return f(d,a)-c},Za=function(a,b,c,d,e){for(var f=F(b.tn,b.ta),g=F(b.tn,b.tb),k=B(b.tn,e),m=c.tVerts,n=0;n<m.length;n+=2){var q=m[n],s=m[n+1];if(q*k.x+s*k.y<u(b.tn,b.ta)*e+b.r){var t=b.tn.x*s-b.tn.y*q;f>=t&&t>=g&&a.push(new S(new r(q,s),k,d,h(c.hashid,n)))}}};
fa.prototype.collisionCode=0;U.prototype.collisionCode=1;J.prototype.collisionCode=2;fa.prototype.collisionTable=[function(a,b){var c=W(a.tc,b.tc,a.r,b.r);return c?[c]:O},function(a,b){var c=b.ta,d=a.tc,e=y(b.tb,c),f=t(u(e,y(d,c))/H(e)),c=w(c,B(e,f));return(d=W(d,c,a.r,b.r))?(c=d.n,0===f&&0>u(c,b.a_tangent)||1===f&&0>u(c,b.b_tangent)?O:[d]):O},function(a,b){for(var c=b.tAxes,d=0,e=u(c[0].n,a.tc)-c[0].d-a.r,f=0;f<c.length;f++){var g=u(c[f].n,a.tc)-c[f].d-a.r;if(0<g)return O;g>e&&(e=g,d=f)}var c=c[d].n,
h=b.tVerts,k=h.length,m=d<<1,d=h[m],f=h[m+1],g=h[(m+2)%k],h=h[(m+3)%k],k=c.x*f-c.y*d,m=c.x*h-c.y*g,n=F(c,a.tc);if(n<m){var q=W(a.tc,new r(g,h),a.r,0,q);return q?[q]:O}return n<k?[new S(y(a.tc,B(c,a.r+e/2)),K(c),e,0)]:(q=W(a.tc,new r(d,f),a.r,0,q))?[q]:O}];U.prototype.collisionTable=[null,function(a,b){return O},function(a,b){var c=[],d=b.tAxes,e=d.length,f=u(a.tn,a.ta),g=b.valueOnAxis(a.tn,f)-a.r,f=b.valueOnAxis(K(a.tn),-f)-a.r;if(0<f||0<g)return O;var k=0,m=Ya(a,d[0].n,d[0].d);if(0<m)return O;for(var n=
0;n<e;n++){var q=Ya(a,d[n].n,d[n].d);if(0<q)return O;q>m&&(m=q,k=n)}d=K(d[k].n);n=w(a.ta,B(d,a.r));q=w(a.tb,B(d,a.r));b.containsVert(n.x,n.y)&&c.push(new S(n,d,m,h(a.hashid,0)));b.containsVert(q.x,q.y)&&c.push(new S(q,d,m,h(a.hashid,1)));if(g>=m||f>=m)g>f?Za(c,a,b,g,1):Za(c,a,b,f,-1);if(0===c.length){g=2*k;f=b.tVerts;m=new r(f[g],f[g+1]);if((k=W(a.ta,m,a.r,0,c))||(k=W(a.tb,m,a.r,0,c)))return[k];e*=2;e=new r(f[(g+2)%e],f[(g+3)%e]);if((k=W(a.ta,e,a.r,0,c))||(k=W(a.tb,e,a.r,0,c)))return[k]}return c}];
J.prototype.collisionTable=[null,null,function(a,b){var c=Wa(b,a.tAxes);if(-1==c)return O;var d=Ga,e=Wa(a,b.tAxes);if(-1==e)return O;var f=Ga;return d>f?Xa(a,b,a.tAxes[c].n,d):Xa(a,b,K(b.tAxes[e].n),f)}];var nb=a.collideShapes=function(a,c){b(a.collisionCode<=c.collisionCode,"Collided shapes must be sorted by type");return a.collisionTable[c.collisionCode](a,c)},$a=new aa,z=a.Space=function(){this.curr_dt=this.stamp=0;this.bodies=[];this.rousedBodies=[];this.sleepingComponents=[];this.staticShapes=
new G(null);this.activeShapes=new G(this.staticShapes);this.arbiters=[];this.contactBuffersHead=null;this.cachedArbiters={};this.constraints=[];this.locked=0;this.collisionHandlers={};this.defaultHandler=$a;this.postStepCallbacks=[];this.iterations=10;this.gravity=v;this.damping=1;this.idleSpeedThreshold=0;this.sleepTimeThreshold=Infinity;this.collisionSlop=0.1;this.collisionBias=Math.pow(0.9,60);this.collisionPersistence=3;this.enableContactGraph=!1;this.staticBody=new A(Infinity,Infinity);this.staticBody.nodeIdleTime=
Infinity;this.collideShapes=this.makeCollideShapes()};z.prototype.getCurrentTimeStep=function(){return this.curr_dt};z.prototype.isLocked=function(){return this.locked};var P=function(a){b(!a.locked,"This addition/removal cannot be done safely during a call to cpSpaceStep()  or during a query. Put these calls into a post-step callback.")};z.prototype.addCollisionHandler=function(a,b,c,d,e,f){P(this);this.removeCollisionHandler(a,b);var g=new aa;g.a=a;g.b=b;c&&(g.begin=c);d&&(g.preSolve=d);e&&(g.postSolve=
e);f&&(g.separate=f);this.collisionHandlers[h(a,b)]=g};z.prototype.removeCollisionHandler=function(a,b){P(this);delete this.collisionHandlers[h(a,b)]};z.prototype.setDefaultCollisionHandler=function(a,b,c,d){P(this);var e=new aa;a&&(e.begin=a);b&&(e.preSolve=b);c&&(e.postSolve=c);d&&(e.separate=d);this.defaultHandler=e};z.prototype.lookupHandler=function(a,b){return this.collisionHandlers[h(a,b)]||this.defaultHandler};z.prototype.addShape=function(a){var c=a.body;if(c.isStatic())return this.addStaticShape(a);
b(!a.space,"This shape is already added to a space and cannot be added to another.");P(this);c.activate();c.addShape(a);a.update(c.p,c.rot);this.activeShapes.insert(a,a.hashid);a.space=this;return a};z.prototype.addStaticShape=function(a){b(!a.space,"This shape is already added to a space and cannot be added to another.");P(this);var c=a.body;c.addShape(a);a.update(c.p,c.rot);this.staticShapes.insert(a,a.hashid);a.space=this;return a};z.prototype.addBody=function(a){b(!a.isStatic(),"Static bodies cannot be added to a space as they are not meant to be simulated.");
b(!a.space,"This body is already added to a space and cannot be added to another.");P(this);this.bodies.push(a);a.space=this;return a};z.prototype.addConstraint=function(a){b(!a.space,"This shape is already added to a space and cannot be added to another.");P(this);var c=a.a,d=a.b;c.activate();d.activate();this.constraints.push(a);a.next_a=c.constraintList;c.constraintList=a;a.next_b=d.constraintList;d.constraintList=a;a.space=this;return a};z.prototype.filterArbiters=function(a,b){for(var c in this.cachedArbiters){var d=
this.cachedArbiters[c];if(a===d.body_a&&(b===d.a||null===b)||a===d.body_b&&(b===d.b||null===b))b&&"cached"!==d.state&&d.callSeparate(this),d.unthread(),k(this.arbiters,d),delete this.cachedArbiters[c]}};z.prototype.removeShape=function(a){var c=a.body;c.isStatic()?this.removeStaticShape(a):(b(this.containsShape(a),"Cannot remove a shape that was not added to the space. (Removed twice maybe?)"),P(this),c.activate(),c.removeShape(a),this.filterArbiters(c,a),this.activeShapes.remove(a,a.hashid),a.space=
null)};z.prototype.removeStaticShape=function(a){b(this.containsShape(a),"Cannot remove a static or sleeping shape that was not added to the space. (Removed twice maybe?)");P(this);var c=a.body;c.isStatic()&&c.activateStatic(a);c.removeShape(a);this.filterArbiters(c,a);this.staticShapes.remove(a,a.hashid);a.space=null};z.prototype.removeBody=function(a){b(this.containsBody(a),"Cannot remove a body that was not added to the space. (Removed twice maybe?)");P(this);a.activate();k(this.bodies,a);a.space=
null};z.prototype.removeConstraint=function(a){b(this.containsConstraint(a),"Cannot remove a constraint that was not added to the space. (Removed twice maybe?)");P(this);a.a.activate();a.b.activate();k(this.constraints,a);a.a.removeConstraint(a);a.b.removeConstraint(a);a.space=null};z.prototype.containsShape=function(a){return a.space===this};z.prototype.containsBody=function(a){return a.space==this};z.prototype.containsConstraint=function(a){return a.space==this};z.prototype.uncacheArbiter=function(a){delete this.cachedArbiters[h(a.a.hashid,
a.b.hashid)];k(this.arbiters,a)};z.prototype.eachBody=function(a){this.lock();for(var b=this.bodies,c=0;c<b.length;c++)a(b[c]);b=this.sleepingComponents;for(c=0;c<b.length;c++)for(var d=b[c];d;){var e=d.nodeNext;a(d);d=e}this.unlock(!0)};z.prototype.eachShape=function(a){this.lock();this.activeShapes.each(a);this.staticShapes.each(a);this.unlock(!0)};z.prototype.eachConstraint=function(a){this.lock();for(var b=this.constraints,c=0;c<b.length;c++)a(b[c]);this.unlock(!0)};z.prototype.reindexStatic=
function(){b(!this.locked,"You cannot manually reindex objects while the space is locked. Wait until the current query or step is complete.");this.staticShapes.each(function(a){var b=a.body;a.update(b.p,b.rot)});this.staticShapes.reindex()};z.prototype.reindexShape=function(a){b(!this.locked,"You cannot manually reindex objects while the space is locked. Wait until the current query or step is complete.");var c=a.body;a.update(c.p,c.rot);this.activeShapes.reindexObject(a,a.hashid);this.staticShapes.reindexObject(a,
a.hashid)};z.prototype.reindexShapesForBody=function(a){for(a=a.shapeList;a;a=a.next)this.reindexShape(a)};z.prototype.useSpatialHash=function(a,b){throw Error("Spatial Hash not yet implemented!");};z.prototype.activateBody=function(a){b(!a.isRogue(),"Internal error: Attempting to activate a rogue body.");if(this.locked)-1===this.rousedBodies.indexOf(a)&&this.rousedBodies.push(a);else{this.bodies.push(a);for(var c=0;c<a.shapeList.length;c++){var d=a.shapeList[c];this.staticShapes.remove(d,d.hashid);
this.activeShapes.insert(d,d.hashid)}for(c=a.arbiterList;c;c=c.next(a))if(d=c.body_a,a===d||d.isStatic()){var d=c.a,e=c.b;this.cachedArbiters[h(d.hashid,e.hashid)]=c;c.stamp=this.stamp;c.handler=this.lookupHandler(d.collision_type,e.collision_type);this.arbiters.push(c)}for(c=a.constraintList;c;c=c.nodeNext)d=c.a,(a===d||d.isStatic())&&this.constraints.push(c)}};z.prototype.deactivateBody=function(a){b(!a.isRogue(),"Internal error: Attempting to deactivate a rogue body.");k(this.bodies,a);for(var c=
0;c<a.shapeList.length;c++){var d=a.shapeList[c];this.activeShapes.remove(d,d.hashid);this.staticShapes.insert(d,d.hashid)}for(d=a.arbiterList;d;d=d.next(a))c=d.body_a,(a===c||c.isStatic())&&this.uncacheArbiter(d);for(d=a.constraintList;d;d=d.nodeNext)c=d.a,(a===c||c.isStatic())&&k(this.constraints,d)};A.prototype.activate=function(){if(!this.isRogue()){this.nodeIdleTime=0;var a=this?this.nodeRoot:null;if(a&&a.isSleeping(a)){b(!a.isRogue(),"Internal Error: componentActivate() called on a rogue body.");
for(var c=a.space,d=a;d;){var e=d.nodeNext;d.nodeIdleTime=0;d.nodeRoot=null;d.nodeNext=null;c.activateBody(d);d=e}k(c.sleepingComponents,a)}}};A.prototype.activateStatic=function(a){b(this.isStatic(),"Body.activateStatic() called on a non-static body.");for(var c=this.arbiterList;c;c=c.next(this))a&&a!=c.a&&a!=c.b||(c.body_a==this?c.body_b:c.body_a).activate()};A.prototype.pushArbiter=function(a){c(null===(a.body_a===this?a.thread_a_next:a.thread_b_next),"Internal Error: Dangling contact graph pointers detected. (A)");
c(null===(a.body_a===this?a.thread_a_prev:a.thread_b_prev),"Internal Error: Dangling contact graph pointers detected. (B)");var b=this.arbiterList;c(null===b||null===(b.body_a===this?b.thread_a_prev:b.thread_b_prev),"Internal Error: Dangling contact graph pointers detected. (C)");a.body_a===this?a.thread_a_next=b:a.thread_b_next=b;b&&(b.body_a===this?b.thread_a_prev=a:b.thread_b_prev=a);this.arbiterList=a};var Ha=function(a,b){if(!b.isRogue()){var d=b?b.nodeRoot:null;if(null==d){b.nodeRoot=a;b!==
a&&(b.nodeNext=a.nodeNext,a.nodeNext=b);for(d=b.arbiterList;d;d=d.next(b))Ha(a,b==d.body_a?d.body_b:d.body_a);for(d=b.constraintList;d;d=d.next(b))Ha(a,b==d.a?d.b:d.a)}else c(d===a,"Internal Error: Inconsistency detected in the contact graph.")}};z.prototype.processComponents=function(a){for(var b=Infinity!==this.sleepTimeThreshold,d=this.bodies,e=0;e<d.length;e++){var f=d[e];c(null===f.nodeNext,"Internal Error: Dangling next pointer detected in contact graph.");c(null===f.nodeRoot,"Internal Error: Dangling root pointer detected in contact graph.")}if(b)for(var g=
(e=this.idleSpeedThreshold)?e*e:H(this.gravity)*a*a,e=0;e<d.length;e++){var f=d[e],h=g?f.m*g:0;f.nodeIdleTime=f.kineticEnergy()>h?0:f.nodeIdleTime+a}g=this.arbiters;e=0;for(h=g.length;e<h;e++){var k=g[e],f=k.body_a;a=k.body_b;b&&((a.isRogue()&&!a.isStatic()||f.isSleeping())&&f.activate(),(f.isRogue()&&!f.isStatic()||a.isSleeping())&&a.activate());f.pushArbiter(k);a.pushArbiter(k)}if(b){b=this.constraints;for(e=0;e<b.length;e++)a=b[e],f=a.a,a=a.b,a.isRogue()&&!a.isStatic()&&f.activate(),f.isRogue()&&
!f.isStatic()&&a.activate();for(e=0;e<d.length;){f=d[e];if(null===(f?f.nodeRoot:null)){Ha(f,f);a:{for(b=f;b;b=b.nodeNext)if(b.nodeIdleTime<this.sleepTimeThreshold){b=!0;break a}b=!1}if(!b){this.sleepingComponents.push(f);for(b=f;b;b=b.nodeNext)this.deactivateBody(b);continue}}e++;f.nodeRoot=null;f.nodeNext=null}}};A.prototype.sleep=function(){this.sleepWithGroup(null)};A.prototype.sleepWithGroup=function(a){b(!this.isStatic()&&!this.isRogue(),"Rogue and static bodies cannot be put to sleep.");var c=
...
a?(this.nodeRoot=a=a?a.nodeRoot:null,this.nodeNext=a.nodeNext,this.nodeIdleTime=0,a.nodeNext=this):(this.nodeRoot=this,this.nodeNext=null,this.nodeIdleTime=0,c.sleepingComponents.push(this));k(c.bodies,this)}};z.prototype.activateShapesTouchingShape=function(a){Infinity!==this.sleepTimeThreshold&&this.shapeQuery(a,function(a,b){a.body.activate()})};z.prototype.pointQuery=function(a,b,c,d){var e=function(e){(!e.group||c!==e.group)&&b&e.layers&&e.pointQuery(a)&&d(e)};this.lock();this.activeShapes.pointQuery(a,
e);this.staticShapes.pointQuery(a,e);this.unlock(!0)};z.prototype.pointQueryFirst=function(a,b,c){var d=null;this.pointQuery(a,b,c,function(a){a.sensor||(d=a)});return d};z.prototype.segmentQuery=function(a,b,c,d,e){var f=function(f){var g;(!f.group||d!==f.group)&&c&f.layers&&(g=f.segmentQuery(a,b))&&e(f,g.t,g.n);return 1};this.lock();this.staticShapes.segmentQuery(a,b,1,f);this.activeShapes.segmentQuery(a,b,1,f);this.unlock(!0)};z.prototype.segmentQueryFirst=function(a,b,c,d){var e=null,f=function(f){var g;
(!f.group||d!==f.group)&&c&f.layers&&!f.sensor&&(g=f.segmentQuery(a,b))&&(null===e||g.t<e.t)&&(e=g);return e?e.t:1};this.staticShapes.segmentQuery(a,b,1,f);this.activeShapes.segmentQuery(a,b,e?e.t:1,f);return e};z.prototype.bbQuery=function(a,b,c,d){var e=function(e){(!e.group||c!==e.group)&&b&e.layers&&a.l<=e.bb_r&&e.bb_l<=a.r&&a.b<=e.bb_t&&e.bb_b<=a.t&&d(e)};this.lock();this.activeShapes.query(a,e);this.staticShapes.query(a,e);this.unlock(!0)};z.prototype.shapeQuery=function(a,b){var c=a.body;c&&
a.update(c.p,c.rot);var c=new ea(a.bb_l,a.bb_b,a.bb_r,a.bb_t),d=!1,e=function(c){if((!a.group||a.group!==c.group)&&a.layers&c.layers&&a!==c){var e;if(a.collisionCode<=c.collisionCode)e=cpCollideShapes(a,c);else{e=cpCollideShapes(c,a);for(var f=0;f<e.length;f++)e[f].n=K(e[f].n)}if(e.length&&(d=!(a.sensor||c.sensor),b)){for(var g=Array(e.length),f=0;f<e.length;f++)g[f]=new Ta(e[f].p,e[f].n,e[f].dist);b(c,g)}}};this.lock();this.activeShapes.query(c,e);this.staticShapes.query(c,e);this.unlock(!0);return d};
z.prototype.addPostStepCallback=function(a){c(this.locked,"Adding a post-step callback when the space is not locked is unnecessary. Post-step callbacks will not called until the end of the next call to cpSpaceStep() or the next query.");this.postStepCallbacks.push(a)};z.prototype.runPostStepCallbacks=function(){for(var a=0;a<this.postStepCallbacks.length;a++)this.postStepCallbacks[a]();this.postStepCallbacks=[]};z.prototype.lock=function(){this.locked++};z.prototype.unlock=function(a){this.locked--;
b(0<=this.locked,"Internal Error: Space lock underflow.");if(!this.locked&&a){a=this.rousedBodies;for(var c=0;c<a.length;c++)this.activateBody(a[c]);a.length=0;this.runPostStepCallbacks()}};z.prototype.makeCollideShapes=function(){var a=this;return function(b,c){if(b.bb_l<=c.bb_r&&c.bb_l<=b.bb_r&&b.bb_b<=c.bb_t&&c.bb_b<=b.bb_t&&b.body!==c.body&&(!b.group||b.group!==c.group)&&b.layers&c.layers){var d=a.lookupHandler(b.collision_type,c.collision_type),e=b.sensor||c.sensor;if(!e||d!==$a){if(b.collisionCode>
c.collisionCode){var f=b;b=c;c=f}f=nb(b,c);if(0!==f.length){var g=h(b.hashid,c.hashid),k=a.cachedArbiters[g];k||(k=a.cachedArbiters[g]=new E(b,c));k.update(f,d,b,c);"first coll"!=k.state||d.begin(k,a)||k.ignore();"ignore"!==k.state&&d.preSolve(k,a)&&!e?a.arbiters.push(k):(k.contacts=null,"ignore"!==k.state&&(k.state="normal"));k.stamp=a.stamp}}}}};z.prototype.arbiterSetFilter=function(a){var b=this.stamp-a.stamp,c=a.body_a,d=a.body_b;if((c.isStatic()||c.isSleeping())&&(d.isStatic()||d.isSleeping()))return!0;
1<=b&&"cached"!=a.state&&(a.callSeparate(this),a.state="cached");return b>=this.collisionPersistence?(a.contacts=null,!1):!0};var ob=function(a){var b=a.body;a.update(b.p,b.rot)};z.prototype.step=function(a){if(0!==a){b(0===v.x&&0===v.y,"vzero is invalid");this.stamp++;var c=this.curr_dt;this.curr_dt=a;for(var d=this.bodies,e=this.constraints,f=this.arbiters,g=0;g<f.length;g++){var h=f[g];h.state="normal";h.body_a.isSleeping()||h.body_b.isSleeping()||h.unthread()}f.length=0;this.lock();for(g=0;g<
d.length;g++)h=d[g],h.position_func(a);this.activeShapes.each(ob);this.activeShapes.reindexQuery(this.collideShapes);this.unlock(!1);this.processComponents(a);this.lock();for(var k in this.cachedArbiters)this.arbiterSetFilter(this.cachedArbiters[k])||delete this.cachedArbiters[k];h=this.collisionSlop;k=1-Math.pow(this.collisionBias,a);for(g=0;g<f.length;g++)f[g].preStep(a,h,k);for(g=0;g<e.length;g++)h=e[g],h.preSolve(this),h.preStep(a);k=Math.pow(this.damping,a);for(var m=this.gravity,g=0;g<d.length;g++)h=
d[g],h.velocity_func(m,k,a);a=0===c?0:a/c;for(g=0;g<f.length;g++)f[g].applyCachedImpulse(a);for(g=0;g<e.length;g++)h=e[g],h.applyCachedImpulse(a);for(g=0;g<this.iterations;g++){for(a=0;a<f.length;a++)f[a].applyImpulse();for(a=0;a<e.length;a++)e[a].applyImpulse()}for(g=0;g<e.length;g++)e[g].postSolve(this);for(g=0;g<f.length;g++)h=f[g],h.handler.postSolve(h,this);this.unlock(!0)}};var Ia=function(a,b,c,d){return new r(b.vx+-d.y*b.w-(a.vx+-c.y*a.w),b.vy+d.x*b.w-(a.vy+c.x*a.w))},Fa=function(a,b,c,d,
e){return(b.vx+-d.y*b.w-(a.vx+-c.y*a.w))*e.x+(b.vy+d.x*b.w-(a.vy+c.x*a.w))*e.y},za=function(a,b,c,d){a.vx+=b*a.m_inv;a.vy+=c*a.m_inv;a.w+=a.i_inv*(d.x*c-d.y*b)},N=function(a,b,c,d,e,f){za(a,-e,-f,c);za(b,e,f,d)},Va=function(a,b,c,d){a.v_biasx+=b*a.m_inv;a.v_biasy+=c*a.m_inv;a.w_bias+=a.i_inv*(d.x*c-d.y*b)},ab=function(a,b,c){b=F(b,c);return a.m_inv+a.i_inv*b*b},la=function(a,b,d,e,f){a=ab(a,d,f)+ab(b,e,f);c(0!==a,"Unsolvable collision or constraint.");return a},bb=function(a,b,d,e,f,g){var h;h=a.m_inv+
b.m_inv;var k=a.i_inv,m=d.x*d.x*k;a=-d.x*d.y*k;d=h+d.y*d.y*k;h+=m;k=b.i_inv;b=e.x*e.x*k;m=-e.x*e.y*k;d+=e.y*e.y*k;e=0+a+m;a=0+a+m;h+=b;b=d*h-e*a;c(0!==b,"Unsolvable constraint.");b=1/b;f.x=h*b;f.y=-e*b;g.x=-a*b;g.y=d*b},C=a.Constraint=function(a,b){this.a=a;this.b=b;this.next_b=this.next_a=this.space=null;this.maxForce=Infinity;this.errorBias=Math.pow(0.9,60);this.maxBias=Infinity};C.prototype.activateBodies=function(){this.a&&this.a.activate();this.b&&this.b.activate()};C.prototype.preStep=function(a){};
C.prototype.applyCachedImpulse=function(a){};C.prototype.applyImpulse=function(){};C.prototype.getImpulse=function(){return 0};C.prototype.preSolve=function(a){};C.prototype.postSolve=function(a){};C.prototype.next=function(a){return this.a===a?this.next_a:this.next_b};var ma=a.PinJoint=function(a,b,d,e){C.call(this,a,b);this.anchr1=d;this.anchr2=e;a=a?w(a.p,D(d,a.rot)):d;b=b?w(b.p,D(e,b.rot)):e;this.dist=x(y(b,a));c(0<this.dist,"You created a 0 length pin joint. A pivot joint will be much more stable.");
this.n=this.r1=this.r2=null;this.bias=this.jnAcc=this.jnMax=this.nMass=0};ma.prototype=Object.create(C.prototype);ma.prototype.preStep=function(a){var b=this.a,c=this.b;this.r1=D(this.anchr1,b.rot);this.r2=D(this.anchr2,c.rot);var d=y(w(c.p,this.r2),w(b.p,this.r1)),e=x(d);this.n=B(d,1/(e?e:Infinity));this.nMass=1/la(b,c,this.r1,this.r2,this.n);b=this.maxBias;this.bias=q(-(1-Math.pow(this.errorBias,a))*(e-this.dist)/a,-b,b);this.jnMax=this.maxForce*a};ma.prototype.applyCachedImpulse=function(a){a=
B(this.n,this.jnAcc*a);N(this.a,this.b,this.r1,this.r2,a.x,a.y)};ma.prototype.applyImpulse=function(){var a=this.a,b=this.b,c=this.n,d=Fa(a,b,this.r1,this.r2,c),d=(this.bias-d)*this.nMass,e=this.jnAcc;this.jnAcc=q(e+d,-this.jnMax,this.jnMax);d=this.jnAcc-e;N(a,b,this.r1,this.r2,c.x*d,c.y*d)};ma.prototype.getImpulse=function(){return Math.abs(this.jnAcc)};var na=a.SlideJoint=function(a,b,c,d,e,f){C.call(this,a,b);this.anchr1=c;this.anchr2=d;this.min=e;this.max=f;this.r1=this.r2=this.n=null;this.bias=
this.jnAcc=this.jnMax=this.nMass=0};na.prototype=Object.create(C.prototype);na.prototype.preStep=function(a){var b=this.a,c=this.b;this.r1=D(this.anchr1,b.rot);this.r2=D(this.anchr2,c.rot);var d=y(w(c.p,this.r2),w(b.p,this.r1)),e=x(d),f=0;e>this.max?(f=e-this.max,this.n=Y(d)):e<this.min?(f=this.min-e,this.n=K(Y(d))):(this.n=v,this.jnAcc=0);this.nMass=1/la(b,c,this.r1,this.r2,this.n);b=this.maxBias;this.bias=q(-(1-Math.pow(this.errorBias,a))*f/a,-b,b);this.jnMax=this.maxForce*a};na.prototype.applyCachedImpulse=
function(a){a*=this.jnAcc;N(this.a,this.b,this.r1,this.r2,this.n.x*a,this.n.y*a)};na.prototype.applyImpulse=function(){if(0!==this.n.x||0!==this.n.y){var a=this.a,b=this.b,c=this.n,d=Ia(a,b,this.r1,this.r2),d=u(d,c),d=(this.bias-d)*this.nMass,e=this.jnAcc;this.jnAcc=q(e+d,-this.jnMax,0);d=this.jnAcc-e;N(a,b,this.r1,this.r2,c.x*d,c.y*d)}};na.prototype.getImpulse=function(){return Math.abs(this.jnAcc)};var oa=a.PivotJoint=function(a,b,c,d){C.call(this,a,b);"undefined"===typeof d&&(d=c,c=a?a.world2Local(d):
d,d=b?b.world2Local(d):d);this.anchr1=c;this.anchr2=d;this.r1=this.r2=v;this.k1=new r(0,0);this.k2=new r(0,0);this.jAcc=v;this.jMaxLen=0;this.bias=v};oa.prototype=Object.create(C.prototype);oa.prototype.preStep=function(a){var b=this.a,c=this.b;this.r1=D(this.anchr1,b.rot);this.r2=D(this.anchr2,c.rot);bb(b,c,this.r1,this.r2,this.k1,this.k2);this.jMaxLen=this.maxForce*a;b=y(w(c.p,this.r2),w(b.p,this.r1));this.bias=Q(B(b,-(1-Math.pow(this.errorBias,a))/a),this.maxBias)};oa.prototype.applyCachedImpulse=
function(a){N(this.a,this.b,this.r1,this.r2,this.jAcc.x*a,this.jAcc.y*a)};oa.prototype.applyImpulse=function(){var a=this.a,b=this.b,c=Ia(a,b,this.r1,this.r2),c=y(this.bias,c),d=this.k2,c=new r(u(c,this.k1),u(c,d)),d=this.jAcc;this.jAcc=Q(w(this.jAcc,c),this.jMaxLen);N(a,b,this.r1,this.r2,this.jAcc.x-d.x,this.jAcc.y-d.y)};oa.prototype.getImpulse=function(){return x(this.jAcc)};var X=a.GrooveJoint=function(a,b,c,d,e){C.call(this,a,b);this.grv_a=c;this.grv_b=d;this.grv_n=L(M(y(d,c)));this.anchr2=e;
this.grv_tn=null;this.clamp=0;this.r1=this.r2=null;this.k1=new r(0,0);this.k2=new r(0,0);this.jAcc=v;this.jMaxLen=0;this.bias=null};X.prototype=Object.create(C.prototype);X.prototype.preStep=function(a){var b=this.a,c=this.b,d=b.local2World(this.grv_a),e=b.local2World(this.grv_b),f=D(this.grv_n,b.rot),g=u(d,f);this.grv_tn=f;this.r2=D(this.anchr2,c.rot);var h=F(w(c.p,this.r2),f);h<=F(d,f)?(this.clamp=1,this.r1=y(d,b.p)):h>=F(e,f)?(this.clamp=-1,this.r1=y(e,b.p)):(this.clamp=0,this.r1=y(w(B(L(f),-h),
B(f,g)),b.p));bb(b,c,this.r1,this.r2,this.k1,this.k2);this.jMaxLen=this.maxForce*a;b=y(w(c.p,this.r2),w(b.p,this.r1));this.bias=Q(B(b,-(1-Math.pow(this.errorBias,a))/a),this.maxBias)};X.prototype.applyCachedImpulse=function(a){N(this.a,this.b,this.r1,this.r2,this.jAcc.x*a,this.jAcc.y*a)};X.prototype.grooveConstrain=function(a){var b=this.grv_tn;a=0<this.clamp*F(a,b)?a:ba(a,b);return Q(a,this.jMaxLen)};X.prototype.applyImpulse=function(){var a=this.a,b=this.b,c=Ia(a,b,this.r1,this.r2),c=y(this.bias,
c),d=this.k2,c=new r(u(c,this.k1),u(c,d)),d=this.jAcc;this.jAcc=this.grooveConstrain(w(d,c));N(a,b,this.r1,this.r2,this.jAcc.x-d.x,this.jAcc.y-d.y)};X.prototype.getImpulse=function(){return x(this.jAcc)};X.prototype.setGrooveA=function(a){this.grv_a=a;this.grv_n=L(M(y(this.grv_b,a)));this.activateBodies()};X.prototype.setGrooveB=function(a){this.grv_b=a;this.grv_n=L(M(y(a,this.grv_a)));this.activateBodies()};var pb=function(a,b){return(a.restLength-b)*a.stiffness},pa=a.DampedSpring=function(a,b,c,
d,e,f,g){C.call(this,a,b);this.anchr1=c;this.anchr2=d;this.restLength=e;this.stiffness=f;this.damping=g;this.springForceFunc=pb;this.target_vrn=this.v_coef=0;this.r1=this.r2=null;this.nMass=0;this.n=null};pa.prototype=Object.create(C.prototype);pa.prototype.preStep=function(a){var b=this.a,d=this.b;this.r1=D(this.anchr1,b.rot);this.r2=D(this.anchr2,d.rot);var e=y(w(d.p,this.r2),w(b.p,this.r1)),f=x(e);this.n=B(e,1/(f?f:Infinity));e=la(b,d,this.r1,this.r2,this.n);c(0!==e,"Unsolvable this.");this.nMass=
1/e;this.target_vrn=0;this.v_coef=1-Math.exp(-this.damping*a*e);f=this.springForceFunc(this,f);N(b,d,this.r1,this.r2,this.n.x*f*a,this.n.y*f*a)};pa.prototype.applyCachedImpulse=function(a){};pa.prototype.applyImpulse=function(){var a=this.a,b=this.b,c=Fa(a,b,this.r1,this.r2,this.n),d=(this.target_vrn-c)*this.v_coef;this.target_vrn=c+d;d*=this.nMass;N(a,b,this.r1,this.r2,this.n.x*d,this.n.y*d)};pa.prototype.getImpulse=function(){return 0};var qb=function(a,b){return(b-a.restAngle)*a.stiffness},Ja=
a.DampedRotarySpring=function(a,b,c,d,e){C.call(this,a,b);this.restAngle=c;this.stiffness=d;this.damping=e;this.springTorqueFunc=qb;this.iSum=this.w_coef=this.target_wrn=0};Ja.prototype=Object.create(C.prototype);Ja.prototype.preStep=function(a){var b=this.a,d=this.b,e=b.i_inv+d.i_inv;c(0!==e,"Unsolvable spring.");this.iSum=1/e;this.w_coef=1-Math.exp(-this.damping*a*e);this.target_wrn=0;a*=this.springTorqueFunc(this,b.a-d.a);b.w-=a*b.i_inv;d.w+=a*d.i_inv};Ja.prototype.applyImpulse=function(){var a=
this.a,b=this.b,c=a.w-b.w,d=(this.target_wrn-c)*this.w_coef;this.target_wrn=c+d;c=d*this.iSum;a.w+=c*a.i_inv;b.w-=c*b.i_inv};var qa=a.RotaryLimitJoint=function(a,b,c,d){C.call(this,a,b);this.min=c;this.max=d;this.iSum=this.bias=this.jMax=this.jAcc=0};qa.prototype=Object.create(C.prototype);qa.prototype.preStep=function(a){var b=this.a,c=this.b,d=c.a-b.a,e=0;d>this.max?e=this.max-d:d<this.min&&(e=this.min-d);this.iSum=1/(1/b.i+1/c.i);b=this.maxBias;this.bias=q(-(1-Math.pow(this.errorBias,a))*e/a,-b,
b);this.jMax=this.maxForce*a;this.bias||(this.jAcc=0)};qa.prototype.applyCachedImpulse=function(a){var b=this.a,c=this.b;a*=this.jAcc;b.w-=a*b.i_inv;c.w+=a*c.i_inv};qa.prototype.applyImpulse=function(){if(this.bias){var a=this.a,b=this.b,c=-(this.bias+(b.w-a.w))*this.iSum,d=this.jAcc;this.jAcc=0>this.bias?q(d+c,0,this.jMax):q(d+c,-this.jMax,0);c=this.jAcc-d;a.w-=c*a.i_inv;b.w+=c*b.i_inv}};qa.prototype.getImpulse=function(){return Math.abs(joint.jAcc)};var ra=a.RatchetJoint=function(a,b,c,d){C.call(this,
a,b);this.angle=0;this.phase=c;this.ratchet=d;this.angle=(b?b.a:0)-(a?a.a:0);this.iSum=this.bias=this.jAcc=this.jMax=0};ra.prototype=Object.create(C.prototype);ra.prototype.preStep=function(a){var b=this.a,c=this.b,d=this.phase,e=this.ratchet,f=c.a-b.a,g=this.angle-f,h=0;0<g*e?h=g:this.angle=Math.floor((f-d)/e)*e+d;this.iSum=1/(b.i_inv+c.i_inv);b=this.maxBias;this.bias=q(-(1-Math.pow(this.errorBias,a))*h/a,-b,b);this.jMax=this.maxForce*a;this.bias||(this.jAcc=0)};ra.prototype.applyCachedImpulse=function(a){var b=
this.a,c=this.b;a*=this.jAcc;b.w-=a*b.i_inv;c.w+=a*c.i_inv};ra.prototype.applyImpulse=function(){if(this.bias){var a=this.a,b=this.b,c=this.ratchet,d=-(this.bias+(b.w-a.w))*this.iSum,e=this.jAcc;this.jAcc=q((e+d)*c,0,this.jMax*Math.abs(c))/c;d=this.jAcc-e;a.w-=d*a.i_inv;b.w+=d*b.i_inv}};ra.prototype.getImpulse=function(a){return Math.abs(a.jAcc)};var ha=a.GearJoint=function(a,b,c,d){C.call(this,a,b);this.phase=c;this.ratio=d;this.ratio_inv=1/d;this.iSum=this.bias=this.jMax=this.jAcc=0};ha.prototype=
Object.create(C.prototype);ha.prototype.preStep=function(a){var b=this.a,c=this.b;this.iSum=1/(b.i_inv*this.ratio_inv+this.ratio*c.i_inv);var d=this.maxBias;this.bias=q(-(1-Math.pow(this.errorBias,a))*(c.a*this.ratio-b.a-this.phase)/a,-d,d);this.jMax=this.maxForce*a};ha.prototype.applyCachedImpulse=function(a){var b=this.a,c=this.b;a*=this.jAcc;b.w-=a*b.i_inv*this.ratio_inv;c.w+=a*c.i_inv};ha.prototype.applyImpulse=function(){var a=this.a,b=this.b,c=(this.bias-(b.w*this.ratio-a.w))*this.iSum,d=this.jAcc;
this.jAcc=q(d+c,-this.jMax,this.jMax);c=this.jAcc-d;a.w-=c*a.i_inv*this.ratio_inv;b.w+=c*b.i_inv};ha.prototype.getImpulse=function(){return Math.abs(this.jAcc)};ha.prototype.setRatio=function(a){this.ratio=a;this.ratio_inv=1/a;this.activateBodies()};var sa=a.SimpleMotor=function(a,b,c){C.call(this,a,b);this.rate=c;this.iSum=this.jMax=this.jAcc=0};sa.prototype=Object.create(C.prototype);sa.prototype.preStep=function(a){this.iSum=1/(this.a.i_inv+this.b.i_inv);this.jMax=this.maxForce*a};sa.prototype.applyCachedImpulse=
...
[],i;for(i in res)g_resources.push(res[i]);var MW=MW||{};MW.SCORE=0;MW.GAME_STATUS={GAME_START:0,GAME_IN:1,GAME_OVER:2};MW.SCALE=1;MW.TIMES=config.times;MW.REMAIN=config.remain;MW.CUR_GAME_STATUS=MW.GAME_STATUS.GAME_START;MW.LEVEL_UP_EVERY=config.point;MW.BLOCK_WIDTH=181;MW.BLOCK_HEIGHT=151;MW.LEVEL_HEIGHT=200;MW.TOP_HEIGHT=389;var winSize,GameLayer=cc.Layer.extend({bgLayer:null,statusLayer:null,cmheight:0,topSprite:null,playOn:!1,separateBox:null,gameOver:!1,score:null,remain:null,topBox:null,timeStart:0,ctor:function(){this._super();winSize=cc.director.getWinSize();this.bgLayer=new cc.Sprite(res.bglist);this.bgLayer.scale=MW.SCALE;this.bgLayer.attr({anchorX:0,anchorY:0,x:0,y:0});this.addChild(this.bgLayer);var a=new cc.Sprite(res.logo_png);a.attr({anchorX:0,anchorY:0,x:30,y:winSize.height-a.height-30});this.addChild(a,
...
collisionPost:function(){return!0},collisionSeparate:function(){return!0},processEvent:function(){this.statusLayer.y-=MW.BLOCK_HEIGHT-40;this.cmheight+=MW.BLOCK_HEIGHT-40;this.statusLayer.cmhight+=MW.BLOCK_HEIGHT-40;this.playOn=!1;this.bgLayer.y=-this.cmheight;this.topBox.visible=!0},playEvent:function(a){if(0>=MW.REMAIN)a=$("body").popup("\u60a8\u4eca\u5929\u5df2\u7ecf\u6ca1\u6709\u6e38\u620f\u673a\u4f1a\u4e86\uff0c\u5206\u4eab\u81f3\u670b\u53cb\u5708\u6210\u529f\u9080\u8bf7\u597d\u53cb\u53ef\u83b7\u5f97\u989d\u5916\u7684\u6e38\u620f\u673a\u4f1a~"),
$("#"+a.id).css({width:"80%",left:"10%","font-size":"1.1em"}).find(".content-body").css("font-size","1.1em");else if(MW.CUR_GAME_STATUS==MW.GAME_STATUS.GAME_IN&&this.statusLayer&&!this.playOn){this.playOn=!0;this.topBox.visible=!1;if(0<=this.topSprite.rotation){a=this.topSprite.height*Math.sin(this.topSprite.rotation*Math.PI/180);var b=this.topSprite.height*Math.cos(this.topSprite.rotation*Math.PI/180);this.statusLayer.initRandomBlock(this.topSprite.x-a,this.topSprite.y-b)}else a=this.topSprite.height*
Math.sin(-this.topSprite.rotation*Math.PI/180),b=this.topSprite.height*Math.cos(-this.topSprite.rotation*Math.PI/180),this.statusLayer.initRandomBlock(this.topSprite.x+a,this.topSprite.y-b);MW.SCORE+=MW.LEVEL_UP_EVERY;0==this.timeStart&&(this.timeStart=new Date)}},initTopSprite:function(){this.topSprite=new cc.Sprite(res.top_png);this.addChild(this.topSprite,2);this.topSprite.attr({anchorX:0.5,anchorY:1,x:cc.visibleRect.width/2-5,y:cc.visibleRect.height-220});this.topBox=new cc.Sprite(res.jimu_png);
this.topBox.attr({anchorX:0.5,anchorY:0,x:this.topSprite.width/2,y:2});this.topSprite.addChild(this.topBox,1);var a=new cc.RotateTo(0.6,30),b=new cc.RotateTo(0.6,0),c=new cc.RotateTo(0.6,-30),a=new cc.RepeatForever(new cc.Sequence(a,b,c,b));this.topSprite.runAction(a)},initCurScore:function(){var a=new cc.Sprite(res.score_png);this.addChild(a,3);a.attr({anchorX:0.5,anchorY:0.5,x:cc.visibleRect.width/2,y:cc.visibleRect.height-250});this.score=new cc.LabelTTF(MW.SCORE,"Arial",90);this.score.color=cc.color(244,
90,19);this.score.attr({anchorX:0.5,anchorY:0.5,x:a.width/2,y:a.height/2-20});a.addChild(this.score);this.remain=new cc.LabelTTF("\u60a8\u8fd8\u80fd\u73a9"+MW.REMAIN+"\u6b21","Arial",30);this.remain.attr({anchorX:0.5,anchorY:0.5,x:a.width/2,y:40});a.addChild(this.remain)},initTimeStatue:function(){var a=new cc.Sprite(res.time_png);this.addChild(a,3);a.attr({anchorX:1,anchorY:1,x:cc.visibleRect.width-40,y:cc.visibleRect.height-50});this.time=new cc.LabelTTF(this.createTimeText(100*MW.TIMES),"Arial",
28);a.addChild(this.time);this.time.attr({anchorX:0.5,anchorY:0.5,x:a.width-60,y:a.height/2});this.timeIcon=new cc.Sprite(res.time_icon_png);a.addChild(this.timeIcon,0);this.timeIcon.attr({anchorX:0,anchorY:0.5,x:57,y:a.height/2-1});this.timeIcon.scaleX=1},gameOVerShow:function(){var a="\u5173\u6ce8\u6211\u4eec\u516c\u4f17\u53f7\uff0c\u4e0e\u670b\u53cb\u4e00\u8d77\u73a9\u6e38\u620f\u5427\u3002";console.log(config.isSubscribe);"True"==config.isSubscribe&&(a="\u5206\u4eab\u81f3\u670b\u53cb\u5708\u6210\u529f\u9080\u8bf7\u597d\u53cb\u53ef\u83b7\u5f97\u989d\u5916\u7684\u6e38\u620f\u673a\u4f1a\u3002");
a=new GameOverLayer(MW.REMAIN-1,MW.SCORE,a);this.addChild(a,5);a.attr({anchorX:0,anchorY:0,x:0,y:0});this.gameRestart();ajax.play(MW.SCORE)},gameRestart:function(){},createTimeText:function(a){a=(1E5+a+"").substr(-4,4);return a=a.substr(0,2)+"'"+a.substr(2)+"''"}}),StatusLayer=cc.Layer.extend({space:null,cmhight:0,curbox:null,ctor:function(a){this.space=a;this._super()},onEnter:function(){this._super();this.initPhysics();this.initBoxWithBody();this.bgLayer=new cc.Sprite(res.bg_png);this.bgLayer.scale=
MW.SCALE;this.bgLayer.attr({anchorX:0,anchorY:0,x:0,y:0});this.addChild(this.bgLayer,0)},initPhysics:function(){var a=this.space,b=a.staticBody;"android"===cc.sys.os.toLowerCase()?a.gravity=cp.v(0,-6E3):a.gravity=cp.v(0,-2500);a.sleepTimeThreshold=0.5;a.collisionSlop=0.5;b=new cp.SegmentShape(b,cp.v(0,0),cp.v(winSize.width,0),-1);b.setElasticity(1);b.setFriction(1);b.setCollisionType(3);b.setLayers(1);a.addShape(b)},initDebugMode:function(){this._debugNode=cc.PhysicsDebugNode.create(this.space);this.addChild(this._debugNode)},
initBoxWithBody:function(){var a=new cp.Body(Infinity,Infinity);a.nodeIdleTime=Infinity;a.setPos(cc.p(winSize.width/2,MW.LEVEL_HEIGHT+2));var b=new cp.BoxShape(a,MW.BLOCK_WIDTH,MW.BLOCK_HEIGHT-40);b.setElasticity(1);b.setFriction(0.5);b.setLayers(2);b.setCollisionType(2);this.space.addShape(b);b=cc.textureCache.addImage(res.jimu_png);b=new cc.PhysicsSprite(b);b.setBody(a);this.addChild(b,1)},initRandomBlock:function(a,b){var c=new cp.Body(1,cp.momentForBox(1,MW.BLOCK_WIDTH,MW.BLOCK_HEIGHT));c.setPos(cc.p(a,
b+this.cmhight));this.space.addBody(c);var d=new cp.BoxShape(c,MW.BLOCK_WIDTH,MW.BLOCK_HEIGHT-40);d.setElasticity(0);d.setFriction(1);d.setCollisionType(1);d.setLayers(3);this.space.addShape(d);d=cc.textureCache.addImage(res.jimu_png);this.curbox=cc.PhysicsSprite.create(d,cc.rect(0,0,MW.BLOCK_WIDTH,MW.BLOCK_HEIGHT));this.curbox.setBody(c);this.addChild(this.curbox,1);this.curbox.setTag(103)},update:function(){}}),HelloWorldScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;
this.addChild(a)}});var MyLoaderScene=cc.Scene.extend({_interval:null,_length:null,_count:null,_label:null,_className:"MyLoaderScene",_logo:null,_logo_bg:null,init:function(){var a=this._bgLayer=new cc.Sprite(res.loading_bg);a.attr({anchorX:0,anchorY:0,x:0,y:0});this.addChild(a,1);var b=this._logo=new cc.Sprite(res.loading);b.attr({anchorX:0.5,anchorY:0.5,x:cc.visibleRect.width/2,y:cc.visibleRect.height/2+120});a.addChild(b,1);this._logo_bg=new cc.Sprite(res.loading_s);this.setbgpercent(0);b.addChild(this._logo_bg,1);
...
a.resources;a._length=b.length;a._count=0;cc.loader.load(b,function(b,d,e){b=e/d*100|0;b=100<=b?100:b;a.setbgpercent(b/100);a._label.setString(b+"%")},function(){a.onExit();setTimeout(function(){a.cb&&a.cb()},200)})},setbgpercent:function(a){this._logo_bg.setTextureRect(cc.rect(0,685,247,-600*a-85))}});MyLoaderScene.preload=function(a,b){var c=null;c=new MyLoaderScene,c.init();c.initWithResources(a,b);cc.director.runScene(c);return c};var GameOverLayer=cc.Layer.extend({remain:0,score:0,text:"",resultSprite:null,ctor:function(a,b,c){this._super();this.remain=a||0;this.score=b||0;this.text=c||""},onEnter:function(){this._super();var a=new cc.Sprite(res.result_bg);a.attr({anchorX:0,anchorY:0,x:0,y:0});this.addChild(a,0);this.resultSprite=new cc.Sprite(res.result);this.resultSprite.attr({anchorX:0.5,anchorY:1,x:a.width/2,y:a.height-160});this.addChild(this.resultSprite,1);this.initRemainText();this.initScoreText();this.initShareText();
...
b){var c=b.getCurrentTarget(),d=c.convertToNodeSpace(a.getLocation()),m=c.getContentSize(),m=cc.rect(0,0,m.width,m.height);cc.rectContainsPoint(m,d)&&("btn1"===c.btnType?"\u518d\u73a9\u4e00\u6b21"===c.btnTypeName?location.reload():location.href="/Game/BuildingBlocks/index":"btn2"===c.btnType&&(c=new ShareLayer,c.attr({anchorX:0,anchorY:0,x:0,y:0}),e.addChild(c,10)));return!0}});cc.eventManager.addListener(b,a);cc.eventManager.addListener(b.clone(),c)},initCloseBtn:function(){var a=new cc.Sprite(res.result_close);
this.resultSprite.addChild(a,2);a.attr({anchorX:1,anchorY:1,x:this.resultSprite.width-100,y:this.resultSprite.height-110});var b=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:function(a,b){var e=b.getCurrentTarget(),f=e.convertToNodeSpace(a.getLocation()),e=e.getContentSize(),e=cc.rect(0,0,e.width,e.height);cc.rectContainsPoint(e,f)&&(location.href="/Game/BuildingBlocks/index");return!0}});cc.eventManager.addListener(b,a)}}),ShareLayer=cc.Layer.extend({ctor:function(){this._super()},
onEnter:function(){this._super();var a=new cc.LayerColor(cc.color(0,0,0,100));this.addChild(a,0);a=new cc.Sprite(res.share);a.scale=2;a.attr({anchorX:1,anchorY:1,x:cc.visibleRect.width,y:cc.visibleRect.height});this.addChild(a,1);a=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,onTouchBegan:function(a,c){var d=c.getCurrentTarget(),e=d.convertToNodeSpace(a.getLocation()),f=d.getContentSize(),f=cc.rect(0,0,f.width,f.height);cc.rectContainsPoint(f,e)&&(d.visible=!1);return!0}});cc.eventManager.addListener(a,
this)}});cc.game.onStart=function(){$("#load").hide();cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(720,1150,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);MyLoaderScene.preload(g_resources,function(){cc.director.runScene(new HelloWorldScene)},this)};cc.game.run();